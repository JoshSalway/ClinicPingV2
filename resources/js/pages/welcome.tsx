...
export default function Welcome() {
    return (
    <>
      <Head title="Welcome | ClinicPing - Patient Management">
        <meta name="description" content="Send medical forms via SMS, manage patients, and track responses with ClinicPing." />
